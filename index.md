...
venue: "mainzed - Mainzer Zentrum für Digitalität in den Geistes- und Kulturwissenschaften"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "Akademie der Wissenschaften und der Literatur | Mainz, Geschwister-Scholl-Straße 2, 55131 Mainz"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
...
latitude: "49.976610"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "8.270540"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "27. März 2023"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "Ganztägig, 9:30 - 17:30 Uhr"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2023-03-27      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2023-03-27        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Stephan Druskat", "Michael Meinel"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Studierende der Digital Humanities"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["software-workshop2023@uni-mainz.de"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2023-03-27-site # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<p>
  ...
  von mainzed-Institutionen reserviert. Um Anmeldung unter folgendem Link wird <a href="https://survey.zdv.uni-mainz.de/index.php/581447?lang=de">Link</a> bis zum 15. März 2023 gebeten.
</p>
...
<h2 id="collaborative_notes">Kollaborative Notizen</h2>

<p>
Wir werden dieses <a href="{{ page.collaborative_notes }}">kollaborative Dokument</a> zum Chatten, für Notizen und zum Austausch von URLs und Code-Schnipseln nutzen.
</p>
<hr/>
{% endif %}
...
<h2 id="schedule"> Vorläufiges Programm</h2>
...
<p>
  ...
  sind häufige Probleme aufgelistet, die während der Installation auftreten können.
</p>
